...
INSERT INTO car_portal_app.car (car_id, number_of_owners, regestration_number, number_of_doors) VALUES (DEFAULT, 1, '2015abcde',5);
SELECT jsonb_pretty((to_json(log))::jsonb) FROM car_portal_app.log ;
...
UPDATE car_portal_app.seller_account_info set email = 'test2@test.com' WHERE seller_account_id=2 RETURNING seller_account_id;
